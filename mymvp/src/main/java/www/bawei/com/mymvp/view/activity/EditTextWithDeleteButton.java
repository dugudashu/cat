...
public class EditTextWithDeleteButton extends android.support.v7.widget.AppCompatEditText{
    ...
    private void init() {
        imgInable = mContext.getResources().getDrawable(R.drawable.a8x);
        imgAble = mContext.getResources().getDrawable(R.drawable.a8x);
